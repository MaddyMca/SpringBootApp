...
public class ProductAttribute implements Serializable {
	...
	private AttributesMaster attribute;
	@ManyToOne(fetch = FetchType.EAGER, optional = false)
	@JoinColumn(nullable = false, referencedColumnName = "productId")
	private Product product;
	private String value;

	public ProductAttribute(int id, AttributesMaster attribute, Product product, String value) {
		super();
		this.id = id;
	...
	public AttributesMaster getAttribute() {
		return attribute;
	}

	public void setAttribute(AttributesMaster attribute) {
		this.attribute = attribute;
	}
